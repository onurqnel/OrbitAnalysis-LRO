...
PRODUCT_CREATION_TIME        = 2010-06-21T21:23:33
...
OBJECT                       = SPICE_KERNEL
  ...
  KERNEL_TYPE                = FRAMES
  DESCRIPTION                = "This file contains the latest
specifications of lunar reference frames realizing the Lunar Principle axis
(PA) and Mean Earth/Polar Axis (ME) reference systems. "
